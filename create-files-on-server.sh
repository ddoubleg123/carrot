#!/bin/bash
mkdir -p /root/sdxl-api
cd /root/sdxl-api

# Create generator_api.py
cat > generator_api.py << 'GENERATOR_EOF'
import os, io, base64
...
class GenerateReq(BaseModel):
    prompt: str
    seed: int = 42
    style: str = "photoreal_portrait"
    face_enhance: Optional[bool] = None
    upscale: int = 2
    jpeg_proxy: bool = True
...
echo "Created generator_api.py"
echo "Setup complete! Files created in /root/sdxl-api"
ls -la /root/sdxl-api
