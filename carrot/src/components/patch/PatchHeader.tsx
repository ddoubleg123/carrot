      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="pt-16 pl-4">
          ...
          <div className="flex flex-wrap items-start justify-between gap-6">
            ...
            {/* Right side: Actions - PROPERLY ALIGNED ICONS */}
            <div className="flex flex-col gap-2 flex-shrink-0 items-start">
        <Button
          onClick={isMember ? () => {} : handleJoin}
          variant={isMember ? "outline" : "secondary"}
          className={isMember 
            ? "border-white/30 text-white hover:bg-white/10 bg-transparent px-4 py-2 flex items-center gap-4" 
            : "bg-white text-[#FF6A00] hover:bg-white/90 px-4 py-2 flex items-center gap-4"
          }
        >
        ...
        <Button
          variant="ghost"
          onClick={handleShare}
          className="text-white hover:bg-white/10 px-4 py-2 flex items-center gap-4"
        >
