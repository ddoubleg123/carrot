...
export default function ColorPickerModal({ open, schemes, currentIndex, onSelect, onClose }: ColorPickerModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center p-3 sm:p-4">
      ...
      <div className="relative bg-white rounded-2xl w-full max-w-md sm:max-w-lg shadow-xl overflow-hidden">
        ...
        <div className="p-3 grid grid-cols-2 gap-2 sm:p-4 sm:grid-cols-3 sm:gap-3">
          {schemes.map((s, i) => (
            <button
              key={i}
