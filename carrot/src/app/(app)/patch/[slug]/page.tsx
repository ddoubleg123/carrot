...
const mockGroup = {
  ...
  avatar: '/api/img?url=https://images.unsplash.com/photo-1466611653911-95081537e5b7?w=100&h=100&fit=crop',
  ...
  const GroupHeader = () => (
    <div className="relative rounded-2xl overflow-hidden mb-6">
      <div 
        ...
        style={{ background: mockGroup.cover }}
      />
      ...
      <div className="absolute bottom-0 left-0 right-0 p-6">
        <div className="flex items-end gap-4">
          ...
          <div className="flex-1 text-white">
            ...
            <p className="text-white/90 mb-4 max-w-2xl">{mockGroup.description}</p>
            <div className="flex items-center gap-6 text-sm">
              <div className="flex items-center gap-2">
                <Users className="w-4 h-4" />
                <span>{mockGroup.stats.members.toLocaleString()} members</span>
              </div>
              <div className="flex items-center gap-2">
                <MessageSquare className="w-4 h-4" />
                <span>{mockGroup.stats.threads} threads</span>
              </div>
              <div className="flex items-center gap-2">
                <History className="w-4 h-4" />
                <span>{mockGroup.stats.events} events</span>
              </div>
            </div>
          </div>
    ...
    <div className={`min-h-screen bg-gray-50 ${inter.className}`}>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500 mb-6">
          ...
          <span className="text-gray-900 font-medium">{mockGroup.name}</span>
          <ChevronRight className="w-4 h-4" />
