...
const PHASES = [
  ...
  },
  {
    ...
    items: [
      { id: 'p2-sw', text: 'Cherokee County Stormwater — Plan Required?', agency: 'stormwater@cherokeecountyga.gov', note: 'Email sent 7/5/2026. Follow-up sent 7/17/2026. Awaiting response. Key question: is a stormwater management plan required given that site runoff drains to two separate lakes? Image of runoff pattern submitted as supporting context. Answer determines scope of LGP. DES (Payton) will also chase confirmation once LGP is under contract.', actionNow: 'Awaiting county email response. This is the only blocker for DES to start LGP.' },
