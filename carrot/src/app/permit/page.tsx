...
const PHASES = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'p3-1', text: 'Septic Permit Application', agency: 'CherokeeEH@dph.ga.gov', note: 'READY TO SEND. Application completed 9/20/2026 — 7 bedrooms (5 main + 2 ADU). DES revised site plan received (26-306_C01_REV_092226): revision block dated 9/1/2026, note REVISED NUMBER OF BEDROOMS. Verified: 455 LF required, 460 LF primary, 700 LF backup, 1,500 gal tank (EH to decide; DES revises to 2,000 gal if required). Soil report #26.306.1 still current. Send application + REV site plan + soil report together. Ben Moers to send hand-signed original soil report to EH. OPEN: confirm LGP reviewer has the revised 7-bedroom sheet.', actionNow: 'Send package to CherokeeEH@dph.ga.gov. Separately confirm with Payton that the LGP under review has the REV sheet.' },
...
const STORAGE_KEY = 'permit-tracker-v18';
