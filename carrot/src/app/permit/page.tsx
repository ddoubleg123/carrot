...
const PHASES = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'p3-1', text: 'Septic Permit Application', agency: 'CherokeeEH@dph.ga.gov', note: 'Application completed 9/20/2026 — 7 bedrooms (5 main + 2 ADU). DES revised site plan 9/21/2026: 455 LF required, 460 LF primary, 700 LF backup, 1,500 gal tank (EH to decide; DES will revise to 2,000 gal if required). Soil report #26.306.1 still current. BEFORE SENDING: Payton to add revision date to sheet (still reads 8/26/2026) and confirm whether LGP under review needs revised sheet. Ben to confirm signed soil report submittal. Submit application + revised site plan + soil report together.', actionNow: 'Waiting on Payton for revision-dated sheet + LGP answer, and Ben on signed soil report. Then send package to CherokeeEH@dph.ga.gov.' },
...
const STORAGE_KEY = 'permit-tracker-v17';
