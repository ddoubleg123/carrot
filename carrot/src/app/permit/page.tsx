...
const PHASES = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'p3-1', text: 'Septic Permit Application', agency: 'Alexandria Walker / CherokeeEH@dph.ga.gov', note: 'SUBMITTED 9/22/2026 — application + REV site plan + soil report. Alexandria Walker (Cherokee EH) returned 4 items same day: (1) floor plans for Gazebo, Greenhouse, Guest House, Main House — SENT 9/22 w/ AG & Associates plan set dated 9/18/2026; (2) recorded plat — SENT by Payton, Book 121 Pg 973; (3) confirm address with GIS after combination — in progress, Daniel handling; (4) separate septic tanks for main house and ADU, they may share a field but not a tank — Payton revising site plan. EH also flagged 1,500 gal will NOT cover 7 bedrooms, and a garbage disposal requires more tank. SOIL REPORT: EH cannot accept — not digitally signed. Ben Moers resubmitting 9/23 with soil scientist signature under the stamp.', actionNow: 'Awaiting: Payton two-tank site plan revision, Ben signed soil report (due 9/23), GIS address confirmation.' },
