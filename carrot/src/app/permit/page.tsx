...
const PHASES = [
  ...
  },
  {
    ...
    items: [
      { id: 'p2-sw', text: 'Cherokee County Stormwater — Confirmed NO Plan Required', agency: 'Andrea Yager / stormwater@cherokeecountyga.gov', note: 'RESOLVED — Andrea Yager confirmed 7/20/2026: Construction submittals (stormwater plan) NOT required as long as disturbance is less than 1 acre. 75-ft impervious setback on both sides of stream confirmed once lots are combined. Keep disturbance under 1 acre and no stormwater plan is needed.' },
      ...
      { id: 'p2-5', text: 'House Location Plan (HLP)', agency: 'DES (Payton) + Rashid', note: 'Architect plan set received 9/18/2026 — AG & Associates Inc (Rashid Garuba), 10 sheets: foundation, 1st floor, 2nd floor, roof, elevations, ADU & gazebo elevations, 3D views. Main house 7,124 SF heated (4,162 1st / 2,962 2nd) + 1,096 SF garage & mech. ADU 1,037 SF heated + 162 SF porch. Gazebo 252 SF open. Greenhouse 18x25. Total under roof 9,717 SF. Plans label 4 bedrooms in main house + 2 in ADU; septic sized conservatively at 7.', actionNow: 'Confirm with Rashid whether greenhouse has any plumbing fixtures, and get greenhouse SF added to his schedule.' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'p3-1', text: 'Septic Permit Application', agency: 'Alexandria Walker / CherokeeEH@dph.ga.gov', note: 'SUBMITTED 9/22/2026. Alexandria Walker returned 4 items. STATUS: (1) Floor plans — SENT 9/22, AG & Associates set dated 9/18/2026. (2) Recorded plat — SENT, Book 121 Pg 973. (3) GIS address confirmation after lot combination — in progress, Daniel handling. (4) Separate tanks per dwelling (may share drain field) — DES revised plan 9/23/2026: 2,000 gal tank (main house, 5 bed + disposal) and 1,500 gal tank (ADU, 2 bed + disposal), both feeding the same 460 LF primary field. Revision block shows 9/1 bedrooms + 9/23 septic. Field unchanged: 455 LF required / 460 LF primary / 700 LF backup. SOIL REPORT: EH could not accept — not digitally signed. Ben Moers having soil scientist sign under stamp, resubmitting direct to EH.', actionNow: 'Send 9/23 revised plan to Alexandria. Confirm with DES which tank serves which dwelling. Outstanding: Ben signed soil report, GIS address.' },
...
const STORAGE_KEY = 'permit-tracker-v21';
    ...
    <div className="min-h-screen bg-gray-950 text-gray-100">
      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        ...
        <div className="mt-6 rounded-xl border border-gray-800 bg-gray-900 px-5 py-4 text-xs text-gray-500 leading-7">
          ...
          DSC (770) 721-7810 · Becky Kerstetter bkerstetter@cherokeecountyga.gov · Stormwater stormwater@cherokeecountyga.gov · Andrea Yager adyager@cherokeecountyga.gov · NGHD Env. Health 770-479-0444 · Alexandria Walker (Cherokee EH) CherokeeEH@dph.ga.gov · Rashid Garuba / AG & Associates 770-242-7809 · DES Austin McKinney amckinney@davisengineers.com · DES Payton Anderson panderson@davisengineers.com · David Salet dsalet@davisengineers.com · Larry Reiter lreiter@davisengineers.com · Ben Moers bmoers@davisengineers.com · (706) 265-1234 · Rashid Garuba (architect) rashidgaruba@gmail.com 770-242-7809 · CCWSA Brad Payne 770-479-1813 Ext.1265 bradp@ccwsa.com · Sawnee EMC Morgan Bennett morgan.bennett@sawnee.coop 770-887-2363 · CityView cityview.cherokeega.com
          <br/>
