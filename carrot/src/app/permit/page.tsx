...
const PHASES = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'p3-1', text: 'Septic Permit Application', agency: 'Alexandria Walker / CherokeeEH@dph.ga.gov', note: 'SUBMITTED 9/22/2026. Alexandria Walker returned 4 items. STATUS: (1) Floor plans — SENT 9/22, AG & Associates set dated 9/18/2026. (2) Recorded plat — SENT, Book 121 Pg 973. (3) GIS address confirmation after lot combination — CONFIRMED with GIS as 146 Sherwood Lane. (4) Separate tanks per dwelling (may share drain field) — DES revised plan 9/23/2026: 2,000 gal tank (main house, 5 bed + disposal) and 1,500 gal tank (ADU, 2 bed + disposal), both feeding the same 460 LF primary field. Revision block shows 9/1 bedrooms + 9/23 septic. Field unchanged: 455 LF required / 460 LF primary / 700 LF backup. SOIL REPORT: EH could not accept — not digitally signed. Ben Moers having soil scientist sign under stamp, resubmitting direct to EH.', actionNow: 'Send 9/23 revised plan + GIS address confirmation to Alexandria. Only item outstanding: Ben signed soil report.' },
...
const STORAGE_KEY = 'permit-tracker-v22';
